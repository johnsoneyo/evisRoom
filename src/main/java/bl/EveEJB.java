...
public class EveEJB {
    ...
    public byte[] downloadInvoice(int order_id) {
        ...
        try {
            ...
            //Test environment
         //   String masterReportFileName = "/home/johnson3yo/Desktop/shop/evi_report/evesi.jrxml";
          //  String subReportFileName = "/home/johnson3yo/Desktop/shop/evi_report/evis_sub.jrxml";
    ...
    public byte[] downloadDispatch(List<ProductOrderDTO> dispatchList) {
        ...
        try {
            ...
            //Test environment
            // jasperDesign = JRXmlLoader.load("/home/johnson3yo/Desktop/shop/evi_report/report2.jrxml");
            //Production environment
    ...
    private String wordChecker(String message) {
        String[] msg_char = message.split("\\s+");
        StringBuilder sb = new StringBuilder();
        
         for(int i=0; i<msg_char.length; i++){
             if(msg_char[i].equalsIgnoreCase("shit")){
                 msg_char[i]="s**t";
                 System.out.println("I @ "+i);
                 sb.append(msg_char[i]).append(" ");
                 System.out.println("String after append "+sb.toString());
             }if(msg_char[i].equalsIgnoreCase("fuck")){
                 msg_char[i]="f**k";
                    System.out.println("I @ "+i);
                 sb.append(msg_char[i]).append(" ");
                  System.out.println("String after append "+sb.toString());
             }
             if(msg_char[i].equals("ass")){
                 msg_char[i]="a*s";
                 sb.append(msg_char[i]).append(" ");
             }
             if(msg_char[i].equals("pussy")){
                 msg_char[i]="p***y";
                 sb.append(msg_char[i]).append(" ");
             }
              if(msg_char[i].equals("dick")){
                 msg_char[i]="d**k";
                 sb.append(msg_char[i]).append(" ");
             }
             else sb.append(msg_char[i]).append(" ");{
             System.out.println("I @ "+i);}
               System.out.println("end of if else "+sb.toString());
         }
...
//54.69.245.79 aws evesintimate
//52.89.14.125 aws evisroom